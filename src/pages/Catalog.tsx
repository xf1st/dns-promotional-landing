...
const Catalog = () => {
  const [products, setProducts] = useState<Product[]>([
    ...
    },
    {
      ...
      price: 119990,
      image: 'https://via.placeholder.com/300x300?text=LG+OLED',
      category: 'Телевизоры',
      rating: 4.9,
      discount: 10,
      inStock: true
    ...
    },
    {
      ...
      price: 199990,
      image: 'https://via.placeholder.com/300x300?text=Canon+EOS+R6',
    ...
    },
    {
      ...
      price: 42990,
      image: 'https://via.placeholder.com/300x300?text=LG+UltraGear',
      category: 'Мониторы',
      rating: 4.7,
      discount: 5,
      inStock: true
