      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-dns-gray flex items-center justify-center text-dns-darkBlue hover:bg-dns-blue hover:text-white transition-colors">
                <Facebook size={18} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-dns-gray flex items-center justify-center text-dns-darkBlue hover:bg-dns-blue hover:text-white transition-colors">
                <Twitter size={18} />
        ...
        <div className="py-6 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="#" className="text-dns-darkGray hover:text-dns-blue transition-colors text-sm">Политика конфиденциальности</a>
            <a href="#" className="text-dns-darkGray hover:text-dns-blue transition-colors text-sm">Условия использования</a>
            <a href="#" className="text-dns-darkGray hover:text-dns-blue transition-colors text-sm">Карта сайта</a>
          </div>
        </div>
      </div>
    </footer>;
